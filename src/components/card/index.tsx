...
const ConfirmationCard: React.FC<ConfirmationCardProps> = ({ url }) => {
 ...
 window.location.href = url; // Lakukan redirect
 }, REDIRECT_DELAY_MS);
 }
 ...
 <div
 id="confirmation-box"
 className={`bg-white dark:bg-gray-800 p-6 md:p-10 rounded-2xl shadow-xl max-w-md w-full mx-auto text-center border border-gray-200 dark:border-gray-700 transition-all duration-500 ease-out ${
